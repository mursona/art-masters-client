...
const BannerItem = ({slide}) => {
    ...
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full">
            ...
            <button className="btn btn-outline bg-fuchsia-100 mr-4">Appointment</button>
            <button className="btn btn-outline border border-fuchsia-100 text-fuchsia-100">Appointment</button>
            </div>
